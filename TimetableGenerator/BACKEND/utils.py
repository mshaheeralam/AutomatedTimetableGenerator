import json
import random
from BACKEND.costs import check_hard_constraints, subjects_order_cost, empty_space_groups_cost, empty_space_teachers_cost, \
    free_hour
from BACKEND.model import Class, Classroom, Data
...
def set_up(num_of_columns):
    ...
    :return: matrix, free
    """
    w, h = num_of_columns, 45                                          # 5 (workdays) * 12 (work hours) = 60
...
def write_solution_to_file(matrix, data, filled, filepath, groups_empty_space, teachers_empty_space, subjects_order):
    ...
    """
    f = open('C:\\Users\\shahe\\OneDrive\\Desktop\\TimetableGenerator\\TimetableGenerator\\BACKEND\\solution_files\\sol_' + filepath, 'w')
